...
type CustomerFormGroupContent = {
  ...
  contractStartDate: FormControl<ICustomer['contractStartDate']>;
  contractEndDate: FormControl<ICustomer['contractEndDate']>;
...
export class CustomerFormService {
  createCustomerFormGroup(customer: CustomerFormGroupInput = { id: null }): CustomerFormGroup {
    ...
    return new FormGroup<CustomerFormGroupContent>({
      ...
      contractStartDate: new FormControl(customerRawValue.contractStartDate, {
        validators: [Validators.required],
      }),
      contractEndDate: new FormControl(customerRawValue.contractEndDate),
